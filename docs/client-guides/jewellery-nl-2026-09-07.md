...
*   **Duxly Translation Shopify-app:** hier controleer je de verwerking en status van vertalingen.
...
*   Vul één duidelijke numerieke ringmaat, prijs, materiaal en goudkaraat in. Een bereik, meerdere maten of een invoer met “+/-” geldt niet als één geldige maat.
...
Bij een productprijs van **€ 2.000 of hoger zijn alle gegenereerde opties gratis**. In het Nederlands wordt dit getoond als **Gratis**. De oude grens van € 1.000 en de oorspronkelijke prijzen uit het bestand van maart zijn niet meer geldig.
...
5. Open in de juiste shop **Shopify-beheer → Apps → Duxly Translation** om de verwerking en status te controleren.
...
Gebruik bij 2ehandssieraden het verouderde veld **Stock available in: 2ehandssieraden** niet voor berekeningen.
